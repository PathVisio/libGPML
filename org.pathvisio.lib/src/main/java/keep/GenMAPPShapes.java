...
/**
 * This class defines and registers some special shapes that are very specific
 * to GenMAPP, such as the GenMAPP ProteinComplex, Vesicle and Ribosome.
 *
...
public class GenMAPPShapes {
	...
	public enum Internal {
		MITOCHONDRIA, SARCOPLASMICRETICULUM, ENDOPLASMICRETICULUM, GOLGIAPPARATUS, BRACE,
