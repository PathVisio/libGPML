...
// * 
// * TreeMap has better performance than HashMap in the (common) case where no
// * attributes are present This map should never contain non-null values, if a
// * value is set to null the key should be removed.
// */
