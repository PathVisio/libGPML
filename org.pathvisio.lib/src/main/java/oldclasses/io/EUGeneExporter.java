...
public class EUGeneExporter implements PathwayExporter {
	...
	private static final DataSource[] GENMAPP_SYSTEMS = new DataSource[] { BioDataSource.ENSEMBL, BioDataSource.UNIPROT,
			BioDataSource.ENTREZ_GENE, BioDataSource.UNIGENE, BioDataSource.AFFY, BioDataSource.AGILENT,
			BioDataSource.HUGO, BioDataSource.PDB, BioDataSource.SGD };
